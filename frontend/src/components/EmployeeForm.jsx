...
/**
 * Form used to create or edit an employee.
 * @param {{employeeToEdit: Object|null, onSave: function, onCancel: function}} props
 * @returns {JSX.Element}
 */
  ...
  return (
    <form className="employee-form" onSubmit={handleSubmit}>
      ...
      <div className="form-buttons">
        {" "}
        {/* Show Update when editing and Add when creating */}
        <button type="submit">
